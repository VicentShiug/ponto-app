-- CreateEnum
CREATE TYPE "CertificateType" AS ENUM ('PARTIAL', 'FULL_DAY');
...
-- CreateIndex
CREATE UNIQUE INDEX "time_entries_user_id_date_key" ON "time_entries"("user_id" ASC, "date" ASC);
...
-- AddForeignKey
ALTER TABLE "medical_certificates" ADD CONSTRAINT "medical_certificates_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "medical_certificates" ADD CONSTRAINT "medical_certificates_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
